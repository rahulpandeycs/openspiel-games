...
class HSRState(object):
  ...
  def set_state(self, cur_player, winner, is_terminal, history, board, num_of_rungs, remaining_jars, remaining_questions, hsr_guess):
  ...
  def apply_action(self, action):
    ...
    elif self._remaining_jars == 0 or self._remaining_questions == 0:
      self._is_terminal = True
